...
*/
  ...
  var $author$project$Asset$waterfall = $author$project$Asset$image(
    "waterfall.jpg"
  );
  var $author$project$CustomElements$view = function (cropData) {
    return A2(
      $elm$html$Html$div,
      _List_fromArray([$elm$html$Html$Attributes$class("center")]),
      _List_fromArray([
        A2(
          $elm$html$Html$h2,
          _List_Nil,
          _List_fromArray([$elm$html$Html$text("Image Crop")])
        ),
        A2(
          $author$project$CustomElements$imageCrop,
          _List_fromArray([
  ...
  var $author$project$CustomElements$main = $elm$browser$Browser$element({
    init: $author$project$CustomElements$init,
    subscriptions: function (_v0) {
      return $elm$core$Platform$Sub$none;
    },
    update: $author$project$CustomElements$update,
    view: $author$project$CustomElements$view,
  });
  _Platform_export({
    CustomElements: {
      init: $author$project$CustomElements$main(
