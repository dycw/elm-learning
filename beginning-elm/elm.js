...
*/
  ...
  var $author$project$HomePage$view = function (model) {
    return A2(
      $elm$html$Html$div,
      _List_fromArray([$elm$html$Html$Attributes$class("jumbotron")]),
      _List_fromArray([
        A2(
          $elm$html$Html$h1,
          _List_Nil,
          _List_fromArray([$elm$html$Html$text("Welcome to Dunder Mifflin!")])
        ),
        A2(
          $elm$html$Html$p,
          _List_Nil,
  ...
  _Platform_export({
    HomePage: { init: _VirtualDom_init($author$project$HomePage$main)(0)(0) },
  });
})(this);
