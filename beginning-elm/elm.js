...
*/
    ...
    return $elm$http$Http$get({
      expect: A2(
        ...
        A2(
          ...
          $author$project$Page$EditPost$PostReceived
        ),
        $author$project$Post$postDecoder
      ),
      url:
  ...
  var $author$project$Page$EditPost$init = F2(function (postId, navKey) {
  ...
  var $author$project$Page$ListPosts$fetchPosts = $elm$http$Http$get({
    expect: A2(
      ...
      A2(
        $elm$core$Basics$composeR,
        $krisajenkins$remotedata$RemoteData$fromResult,
        $author$project$Page$ListPosts$PostsReceived
      ),
      $author$project$Post$postsDecoder
    ),
  ...
  var $author$project$Post$emptyPostId = $author$project$Post$PostId(-1);
  var $author$project$Post$emptyPost = {
    authorName: "",
    authorUrl: "",
    id: $author$project$Post$emptyPostId,
    title: "",
  };
  ...
  var $author$project$Main$initCurrentPage = F2(function (posts, _v0) {
    ...
    var _v1 = (function () {
      ...
      switch (_v2.$) {
        ...
        case "Post":
          var postId = _v2.a;
          var _v4 = A2(
            $author$project$Page$EditPost$init,
            postId,
            model.navKey
          );
          var pageModel = _v4.a;
    ...
    return _Utils_Tuple2(
      _Utils_update(model, { page: currentPage }),
  ...
  var $author$project$Route$parseUrl = function (url) {
    var _v0 = A2(
      ...
      $author$project$Route$matchRoute,
      url
    );
    if (_v0.$ === "Just") {
      var route = _v0.a;
  ...
  var $author$project$Error$buildErrorMessage = function (httpError) {
    switch (httpError.$) {
      ...
      case "BadStatus":
        var _int = httpError.a;
        return (
          "Request failed with status code: " + $elm$core$String$fromInt(_int)
        );
      default:
        var string = httpError.a;
        return string;
  ...
  var $krisajenkins$remotedata$RemoteData$map = F2(function (f, data) {
    switch (data.$) {
      case "Success":
        var value = data.a;
        return $krisajenkins$remotedata$RemoteData$Success(f(value));
      case "Loading":
        return $krisajenkins$remotedata$RemoteData$Loading;
      case "NotAsked":
  ...
  var $author$project$Route$pushUrl = F2(function (route, navKey) {
    return A2(
  ...
  var $author$project$Post$postEncoder = function (post) {
    return $elm$json$Json$Encode$object(
      _List_fromArray([
        _Utils_Tuple2("id", $author$project$Post$encodeId(post.id)),
        _Utils_Tuple2("title", $elm$json$Json$Encode$string(post.title)),
        _Utils_Tuple2(
          "authorName",
  ...
  var $author$project$Page$EditPost$savePost = function (post) {
    if (post.$ === "Success") {
      ...
      return $elm$http$Http$request({
        ...
        expect: A2(
          $elm$http$Http$expectJson,
          $author$project$Page$EditPost$PostSaved,
          $author$project$Post$postDecoder
        ),
        headers: _List_Nil,
        method: "PATCH",
        ...
        url:
          "http://localhost:5019/posts/" +
          $author$project$Post$idToString(postData.id),
      });
    } else {
    ...
    switch (msg.$) {
        ...
        return _Utils_Tuple2(
          _Utils_update(model, {
            post: A2(
              ...
              function (postData) {
                return _Utils_update(postData, { title: newTitle });
              },
              model.post
            ),
          }),
        ...
        return _Utils_Tuple2(
          _Utils_update(model, {
            post: A2(
              $krisajenkins$remotedata$RemoteData$map,
              function (postData) {
                return _Utils_update(postData, { authorName: newName });
              },
              model.post
            ),
          }),
        ...
        return _Utils_Tuple2(
          _Utils_update(model, {
            post: A2(
              $krisajenkins$remotedata$RemoteData$map,
              function (postData) {
                return _Utils_update(postData, { authorUrl: newUrl });
              },
              model.post
            ),
          }),
      ...
      default:
        if (msg.a.$ === "Ok") {
          ...
          return _Utils_Tuple2(
            _Utils_update(model, {
              post: $krisajenkins$remotedata$RemoteData$succeed(postData),
              saveError: $elm$core$Maybe$Nothing,
            }),
            A2(
  ...
  var $author$project$Page$ListPosts$deletePost = function (postId) {
    return $elm$http$Http$request({
      ...
      expect: $elm$http$Http$expectString(
        $author$project$Page$ListPosts$PostDeleted
      ),
      headers: _List_Nil,
      method: "DELETE",
      timeout: $elm$core$Maybe$Nothing,
  ...
  var $author$project$Ports$storePosts = _Platform_outgoingPort(
    "storePosts",
  ...
  var $author$project$Page$ListPosts$update = F2(function (msg, model) {
    switch (msg.$) {
      case "FetchPosts":
        return _Utils_Tuple2(
          _Utils_update(model, {
      ...
      case "PostsReceived":
        ...
        return _Utils_Tuple2(
          _Utils_update(model, { posts: response }),
          savePostsCmd
        );
      case "DeletePost":
        var postId = msg.a;
  ...
  var $author$project$Page$NewPost$createPost = function (post) {
    return $elm$http$Http$post({
      body: $elm$http$Http$jsonBody($author$project$Post$postEncoder(post)),
      expect: A2(
        $elm$http$Http$expectJson,
        $author$project$Page$NewPost$PostCreated,
        $author$project$Post$postDecoder
      ),
      url: "http://localhost:5019/posts",
    });
  };
  var $author$project$Page$NewPost$update = F2(function (msg, model) {
    switch (msg.$) {
      case "StoreTitle":
        var title = msg.a;
        ...
        return _Utils_Tuple2(
          _Utils_update(model, {
            post: _Utils_update(oldPost, { title: title }),
          }),
          $elm$core$Platform$Cmd$none
        );
      case "StoreAuthorName":
        ...
        return _Utils_Tuple2(
          _Utils_update(model, {
            post: _Utils_update(oldPost, { authorName: name }),
          }),
          $elm$core$Platform$Cmd$none
        );
      case "StoreAuthorUrl":
        ...
        return _Utils_Tuple2(
          _Utils_update(model, {
            post: _Utils_update(oldPost, { authorUrl: url }),
          }),
          $elm$core$Platform$Cmd$none
        );
      case "CreatePost":
      ...
      switch (_v0.a.$) {
        case "ListPageMsg":
          if (_v0.b.$ === "ListPage") {
            ...
            var _v1 = A2(
              $author$project$Page$ListPosts$update,
              subMsg,
              pageModel
            );
        ...
        case "EditPageMsg":
          if (_v0.b.$ === "EditPage") {
            ...
            var pageModel = _v0.b.a;
            var _v3 = A2(
              $author$project$Page$EditPost$update,
              subMsg,
              pageModel
            );
            ...
            A2(
              ...
              _List_fromArray([
                ...
                $elm$html$Html$Events$onInput(
                  $author$project$Page$EditPost$UpdateTitle
                ),
              ]),
              _List_Nil
            ),
          ...
          _List_fromArray([
            ...
            A2(
              ...
              _List_fromArray([
                ...
                $elm$html$Html$Events$onInput(
                  $author$project$Page$EditPost$UpdateAuthorName
                ),
              ]),
              _List_Nil
            ),
          ...
          _List_fromArray([
            ...
            A2(
              ...
              _List_fromArray([
                ...
                $elm$html$Html$Events$onInput(
                  $author$project$Page$EditPost$UpdateAuthorUrl
                ),
              ]),
              _List_Nil
            ),
            ...
            A2(
              ...
              _List_fromArray([
                ...
                $elm$html$Html$Events$onClick(
                  $author$project$Page$EditPost$SavePost
                ),
              ]),
              _List_fromArray([$elm$html$Html$text("Submit")])
            ),
          ])
        ),
      ])
  ...
  var $author$project$Page$EditPost$viewFetchError = function (string) {
    return A2(
      $elm$html$Html$div,
      _List_Nil,
      _List_fromArray([
        A2(
          ...
          _List_Nil,
          _List_fromArray([
            $elm$html$Html$text("Couldn't fetch post at this time."),
          ])
        ),
        $elm$html$Html$text("Error: " + string),
      ])
    );
  };
    ...
    switch (post.$) {
      ...
      case "Loading":
        return A2(
          $elm$html$Html$h3,
          _List_Nil,
          _List_fromArray([$elm$html$Html$text("Loading Post...")])
        );
      case "Success":
        var postData = post.a;
  ...
  var $author$project$Page$EditPost$viewSaveError = function (maybeString) {
    if (maybeString.$ === "Just") {
    ...
    return A2(
      ...
      _List_fromArray([
        A2(
          $elm$html$Html$h3,
          _List_Nil,
          _List_fromArray([$elm$html$Html$text("Edit Post")])
        ),
  ...
  var $author$project$Page$ListPosts$viewDeleteError = function (maybeString) {
    if (maybeString.$ === "Just") {
      var string = maybeString.a;
      return A2(
        $elm$html$Html$div,
  ...
  var $author$project$Page$ListPosts$viewFetchError = function (string) {
    return A2(
      $elm$html$Html$div,
      _List_Nil,
      _List_fromArray([
        A2(
          ...
          _List_Nil,
          _List_fromArray([
            $elm$html$Html$text("Couldn't fetch posts at this time."),
          ])
        ),
        $elm$html$Html$text("Error: " + string),
      ])
    ...
    return A2(
      ...
      _List_fromArray([
        A2(
          ...
          _List_Nil,
          _List_fromArray([
            $elm$html$Html$text($author$project$Post$idToString(post.id)),
          ])
        ),
        A2(
          $elm$html$Html$td,
          _List_Nil,
          _List_fromArray([$elm$html$Html$text(post.title)])
        ),
        A2(
          $elm$html$Html$td,
          _List_Nil,
          _List_fromArray([
            A2(
              $elm$html$Html$a,
              _List_fromArray([$elm$html$Html$Attributes$href(post.authorUrl)]),
              _List_fromArray([$elm$html$Html$text(post.authorName)])
            ),
          ])
        ),
        A2(
            ...
            A2(
              ...
              _List_fromArray([
                $elm$html$Html$Attributes$href(
                  "/posts/" + $author$project$Post$idToString(post.id)
                ),
              ]),
              _List_fromArray([$elm$html$Html$text("Edit")])
            ),
          ])
        ),
        A2(
          ...
          _List_fromArray([
            A2(
              ...
              _List_fromArray([$elm$html$Html$text("Delete")])
            ),
          ])
        ),
      ])
  ...
  var $author$project$Page$ListPosts$viewTableHeader = A2(
    ...
    _List_fromArray([
      A2(
        $elm$html$Html$th,
        _List_Nil,
        _List_fromArray([$elm$html$Html$text("ID")])
      ),
      A2(
        $elm$html$Html$th,
        _List_Nil,
      ...
      A2(
        $elm$html$Html$th,
        _List_Nil,
        _List_fromArray([$elm$html$Html$text("Author")])
      ),
    ])
  );
        ...
        return A2(
          ...
          _List_fromArray([
            A2(
              $elm$html$Html$h3,
              _List_Nil,
              _List_fromArray([$elm$html$Html$text("Posts")])
            ),
            A2(
              $elm$html$Html$table,
              _List_Nil,
              _Utils_ap(
                ...
                A2(
                  $elm$core$List$map,
                  $author$project$Page$ListPosts$viewPost,
                  actualPosts
                )
              )
            ),
    ...
    return A2(
      ...
      _List_fromArray([
        A2(
          ...
          _List_fromArray([$elm$html$Html$text("Refresh posts")])
        ),
        A2($elm$html$Html$br, _List_Nil, _List_Nil),
        A2($elm$html$Html$br, _List_Nil, _List_Nil),
        A2(
          $elm$html$Html$a,
          _List_fromArray([$elm$html$Html$Attributes$href("/posts/new")]),
          _List_fromArray([$elm$html$Html$text("Create new post")])
        ),
        ...
        _List_fromArray([
          ...
          A2(
            ...
            _List_fromArray([
              $elm$html$Html$Attributes$type_("text"),
              $elm$html$Html$Events$onInput(
                $author$project$Page$NewPost$StoreTitle
              ),
            ]),
            _List_Nil
          ),
        ...
        _List_fromArray([
          ...
          A2(
            ...
            _List_fromArray([
              $elm$html$Html$Attributes$type_("text"),
              $elm$html$Html$Events$onInput(
                $author$project$Page$NewPost$StoreAuthorName
              ),
            ]),
            _List_Nil
          ),
        ...
        _List_fromArray([
          ...
          A2(
            ...
            _List_fromArray([
              $elm$html$Html$Attributes$type_("text"),
              $elm$html$Html$Events$onInput(
                $author$project$Page$NewPost$StoreAuthorUrl
              ),
            ]),
            _List_Nil
          ),
        ...
        _List_fromArray([
          A2(
            ...
            _List_fromArray([
              $elm$html$Html$Attributes$type_("button"),
              $elm$html$Html$Events$onClick(
                $author$project$Page$NewPost$CreatePost
              ),
            ]),
            _List_fromArray([$elm$html$Html$text("Submit")])
          ),
  ...
  var $author$project$Main$view = function (model) {
    return {
      body: _List_fromArray([$author$project$Main$currentView(model)]),
      title: "Post App",
    };
  };
