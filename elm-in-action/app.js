...
*/
  ...
  var $author$project$PhotoGroove$view = function (model) {
    return A2(
      $elm$html$Html$div,
      _List_fromArray([$elm$html$Html$Attributes$class("content")]),
      _List_fromArray([
        A2(
          $elm$html$Html$h1,
          _List_Nil,
          _List_fromArray([$elm$html$Html$text("Photo Groove")])
        ),
        A2(
          $elm$html$Html$div,
          _List_fromArray([$elm$html$Html$Attributes$id("thumbnails")]),
          _List_fromArray([
            A2(
              $elm$html$Html$img,
              _List_fromArray([
                $elm$html$Html$Attributes$src(
                  "http://elm-in-action.com/1.jpeg"
                ),
              ]),
              _List_Nil
            ),
  ...
  var $author$project$PhotoGroove$main = $author$project$PhotoGroove$view(
    "no model yet"
  );
  _Platform_export({
    PhotoGroove: {
      init: _VirtualDom_init($author$project$PhotoGroove$main)(0)(0),
    },
  });
})(this);
