...
*/
  ...
  var $author$project$Main$initialModel = F2(function (url, key) {
    return {
      navigation: {
        key: key,
        page: (function () {
          var _v0 = $author$project$Main$fromUrl(url);
          if (_v0.$ === "Nothing") {
  ...
  var $author$project$Main$update = F2(function (msg, model) {
    ...
    if (_v0.$ === "UrlRequested") {
      ...
      return _Utils_Tuple2(
        _Utils_update(model, {
          navigation: _Utils_update(navigation, {
            page: (function () {
              var _v2 = $author$project$Main$fromUrl(url);
              if (_v2.$ === "Nothing") {
                return $author$project$Main$NotFound;
              } else {
                var a = _v2.a;
          ...
          _List_fromArray([
            A2(
              ...
              _List_fromArray([
                A2(
                  $elm$html$Html$a,
                  _List_fromArray([$elm$html$Html$Attributes$href("#/")]),
            ...
            A2(
              ...
              _List_fromArray([
                A2(
                  $elm$html$Html$a,
                  _List_fromArray([$elm$html$Html$Attributes$href("#/about")]),
          ...
          _List_fromArray([
            (function () {
              ...
              switch (_v0.$) {
                ...
                default:
                  return $elm$html$Html$text("About page");
              }
            })(),
          ])
        ),
  ...
  var $author$project$Main$view = function (model) {
    return {
      body: _List_fromArray([$author$project$Main$bodyView(model)]),
      title: "hello title",
    };
  };
